...
namespace efc_final
{
    [Activity(Label = "AddItemCameraPage", NoHistory = false)]
    public class AddItemCameraPage : AppCompatActivity
    { 
        ...
        // получение фотографии из камеры
        ...
        // переданное пользователем изображение передается веб приложение для распознавания текста
        ...
        // полученный распознанный текст/полученный штрихкод отправлется на сохранение товара
        private void SeeDetectedTextButton_Click(object sender, EventArgs e)
        {
            ...
            {
                CameraPage.TextResultRedacted=SeeDetectedText.Text;
